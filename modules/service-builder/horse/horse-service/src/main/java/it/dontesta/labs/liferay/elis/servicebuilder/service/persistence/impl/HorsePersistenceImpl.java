...
public class HorsePersistenceImpl extends BasePersistenceImpl<Horse>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_RESOURCEBLOCKID =
		new FinderPath(HorseModelImpl.ENTITY_CACHE_ENABLED,
			...
			HorseModelImpl.RESOURCEBLOCKID_COLUMN_BITMASK |
			HorseModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_RESOURCEBLOCKID = new FinderPath(HorseModelImpl.ENTITY_CACHE_ENABLED,
			HorseModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<Horse> findByResourceBlockId(long resourceBlockId) {
	 ...
	 */
	@Override
	public List<Horse> findByResourceBlockId(long resourceBlockId, int start,
		int end) {
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Horse horse : list) {
					if ((resourceBlockId != horse.getResourceBlockId())) {
						list = null;
	 ...
	 */
	@Override
	public Horse findByResourceBlockId_First(long resourceBlockId,
		OrderByComparator<Horse> orderByComparator) throws NoSuchHorseException {
		Horse horse = fetchByResourceBlockId_First(resourceBlockId,
				orderByComparator);
	 ...
	 */
	@Override
	public Horse fetchByResourceBlockId_First(long resourceBlockId,
		OrderByComparator<Horse> orderByComparator) {
		List<Horse> list = findByResourceBlockId(resourceBlockId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public Horse findByResourceBlockId_Last(long resourceBlockId,
		OrderByComparator<Horse> orderByComparator) throws NoSuchHorseException {
		Horse horse = fetchByResourceBlockId_Last(resourceBlockId,
				orderByComparator);
	 ...
	 */
	@Override
	public Horse fetchByResourceBlockId_Last(long resourceBlockId,
		OrderByComparator<Horse> orderByComparator) {
		...
		List<Horse> list = findByResourceBlockId(resourceBlockId, count - 1,
	 ...
	 */
	@Override
	public Horse[] findByResourceBlockId_PrevAndNext(long horseId,
		...
		try {
			...
			array[0] = getByResourceBlockId_PrevAndNext(session, horse,
					resourceBlockId, orderByComparator, true);

			array[1] = horse;

			array[2] = getByResourceBlockId_PrevAndNext(session, horse,
	...
	protected Horse getByResourceBlockId_PrevAndNext(Session session,
		Horse horse, long resourceBlockId,
	...
	public void removeByResourceBlockId(long resourceBlockId) {
		for (Horse horse : findByResourceBlockId(resourceBlockId,
	...
	public Horse updateImpl(Horse horse) {
		...
		if (isNew || !HorseModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((horseModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						horseModelImpl.getOriginalResourceBlockId()
					};
				...
				args = new Object[] { horseModelImpl.getResourceBlockId() };
