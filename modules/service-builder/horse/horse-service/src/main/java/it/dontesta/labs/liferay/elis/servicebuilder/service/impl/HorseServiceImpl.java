 ...
 * {@link it.dontesta.labs.liferay.elis.servicebuilder.service.HorseService}
...
public class HorseServiceImpl extends HorseServiceBaseImpl {
	...
	@Override
	public Horse getHorse(long horseId)
		throws NoSuchHorseException {

		return getHorsePersistence().findByPrimaryKey(horseId);
	}
